...
# STM324XG_EVAL=1	  # ST STM324XG_EVAL
# PORT407Z=1		  # Waveshare Port407Z
# MINIM4=1		  # mikroe MINI-M4
# CARAMBOLA=1
# RASPBERRYPI=1
# LPC1768=1 # beta
...
USE_NET=1
USE_GRAPHICS=1
DEFINES += -DUSE_USB_OTG_FS=1 -DPLL_M=8
...
OPTIMIZEFLAGS+=-Os # short on program memory
else ifdef STM324XG_EVAL
EMBEDDED=1
USE_NET=1
USE_GRAPHICS=1
DEFINES += -DUSE_USB_OTG_FS=1 -DPLL_M=25
BOARD=STM324XG_EVAL
STLIB=STM32F4XX
PRECOMPILED_OBJS+=$(ROOT)/targetlibs/stm32f4/lib/startup_stm32f4xx.o
OPTIMIZEFLAGS+=-O3
...
USE_NET=1
USE_GRAPHICS=1
DEFINES += -DUSE_USB_OTG_FS=1  -DPLL_M=16
BOARD=MINIM4
STLIB=STM32F4XX
PRECOMPILED_OBJS+=$(ROOT)/targetlibs/stm32f4/lib/startup_stm32f4xx.o
OPTIMIZEFLAGS+=-O3
